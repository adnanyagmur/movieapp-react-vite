...
const response = await axios.get(
  `https://api.themoviedb.org/3/movie/${movieId.toString()}`,
  {
    params: {
    ...
    <Card sx={{ maxWidth: 250, mt: 3 }}>
      ...
      <CardActions>
        <Grid container justifyContent="space-between" alignItems="flex-end">
          ...
          <Grid item>
            <Button variant="text"  startIcon={<DetailsIcon />} sx={{ fontSize: '0.8rem' }} onClick={(key)=>fetchMovieDetails(key as unknown as number)}>
              Details
            </Button>
          </Grid>
        </Grid>
