...
const response = await axios.get(
  `https://api.themoviedb.org/3/movie/19344/credits}`,
  {
    params: {
      api_key: "Bearer ab517a924bb34407923d1e5fab7eccbd",
      language: 'en-US',
    },
  }
);
    ...
    <Card sx={{ maxWidth: 250, mt: 3 }}>
      ...
      <CardActions>
        <Grid container justifyContent="space-between" alignItems="flex-end">
          ...
          <Grid item>
            <Button variant="text"  startIcon={<DetailsIcon />} sx={{ fontSize: '0.8rem' }} onClick={(key)=>fetchMovieDetails(19344)}>
              Details
            </Button>
          </Grid>
        </Grid>
