...
console.log("detayyy", response)
    ...
    const isFavorite = favorites.some((fav: MovieCardProps) => fav.movieId === movieId);
   ...
   // const favorites = JSON.parse(localStorage.getItem('favorites') || '[]');
    console.log('Favorites:', favorites.filter((fav:MovieCardProps)=> fav.movieId === movieId)); // Eklenecek log
