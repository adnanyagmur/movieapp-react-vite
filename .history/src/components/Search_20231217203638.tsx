...
console.log("handleFİlterSeach ADVANCED FİLTERİGN", advancedFilter)
  ...
  const handleTextFilters = (searchText:string) => {
    if (searchText.trim() !== "" && searchText.length >= 2) {
     dispatch(commitBasicFilterData(seachText))
    } 

    console.log("eacttetxt",seachText)
  };
      ...
      <Stack direction="row" spacing={1}>
        <TextField
          ...
          onChange={(e)=>{
            ...
            const seact = e.target.value as string
            console.log("e.target.value",e.target.value)
            handleTextFilters(seact)}}
        />
        <Button
          variant="contained"
          color="inherit"
