...
const Search = () => {
  ...
  fullScreen={window.innerWidth < 600}
      >
        ...
        <DialogActions>
          <Button onClick={handleDialogClose} color="secondary" sx={{ fontWeight: "bold", mt: { xs: 1, md: 0 }, mr: { xs: 0, md: 1 } }}>
            Cancel
          </Button>
          <Button onClick={handleAdvancedFilterApply} color="primary" sx={{ fontWeight: "bold", mt: { xs: 1, md: 0 }, mr: { xs: 0, md: 1 } }}>
          Filter
          </Button>
        </DialogActions>
      </Dialog>
