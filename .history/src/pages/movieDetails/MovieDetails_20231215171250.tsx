...
const containerRef = useRef<HTMLDivElement | null>(null);
  ...
  const scrollLeft = () => {
    ...
    if (container) {
      container.scrollTo({
        left: container.scrollLeft - 200, // Adjust the scroll distance as needed
        behavior: 'smooth',
      });
    }
  };
...
<Grid item xs={12}>
      <Paper elevation={3} sx={{ p: 2, m: 2 }}>
        <Typography variant="h6" gutterBottom sx={{ fontFamily: 'fantasy', ml: 2, mb: 1 }}>
          Lead actors
        </Typography>
        <div
          ref={containerRef}
          style={{ overflowX: 'auto', display: 'flex', position: 'relative' }}
