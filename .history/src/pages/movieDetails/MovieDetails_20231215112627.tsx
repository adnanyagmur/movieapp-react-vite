        ...
        <Grid item xs={12}>
          <Paper elevation={3} sx={{ m: 2 }}>
            <Stack direction="row" spacing={2}>
              <Grid xs={5}>
                <Card  sx={{ maxWidth: 350, maxHeight: 450,m: 3 }}>
                  <CardMedia
                    component="img"
                    height="500"
              ...
              <Stack direction="column" spacing={2} sx={{m:3}}>
                  ...
                  <Rating name="movie-rating"  value={movieDetails?.vote_average ?  movieDetails?.vote_average / 2 : 0} precision={0.5} readOnly sx={{ marginRight: '1rem' }} />
                  <Typography variant="body1">
                    {movieDetails?.overview}
                  </Typography>
                  <Button variant="outlined" onClick={handleTrailerOpen} startIcon={<LiveTvIcon/>}>
                    Watch Trailer
                  </Button>
                </Stack>
              </Grid>
