...
export const MovieDetails = () => {
  ...
  return (
    <>
      <Grid container spacing={2} sx={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500${movieImage?.posters[0].file_path})`, backgroundSize: 'cover', minHeight: '100vh' }}>
        {/* Movie Poster and Overview */}
        <Grid item xs={12}>
          <Paper elevation={3} sx={{ m: 2, backgroundImage: `url(https://image.tmdb.org/t/p/w500${movieImage?.backdrops[0].file_path})`, backgroundSize: 'cover', minHeight: '100vh'  }}>
            <Stack direction="row" spacing={2}>
              ...
              <Grid xs={7}>
                <Stack direction="column" spacing={2} sx={{ m: 3 }}>
                  ...
                  <Grid>
                  <Chip label={movieDetails?.release_date } variant="filled" color="warning" icon={<HistoryEduIcon/>} /> 
                  </Grid>
                  <Stack direction="row" spacing={2} sx={{ m: 3 }}>
                    {movieDetails?.genres.map(
                      (genre: { id: number; name: string }) => (
                        <Chip label={genre?.name} variant="outlined" color="warning">
