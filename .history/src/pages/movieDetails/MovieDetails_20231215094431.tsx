...
export const MovieDetails = () => {
 ...
 // const movieDetailSelector = useSelector(selectMovieDetails);
  ...
  const [castAndCrew, setCastAndCrew] = useState<MovieCreditsDTO>();
  const [videos, setVideos] = useState<VideoPageDTO>();
...
setMovieDetails(detailResponse.data)
    ...
    fetchMovieDetails();
  }, [movieDetailSelector, setCastAndCrew, setVideos, setPopularMovies, setReviews, setSimilarMovies]);
