  ...
  return (
    <>
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          <Tab label="Lead actors"  icon={<PeopleIcon /> } iconPosition="start"/>
          <Tab label="Item Two2" />
          <Tab label="Item Three3" />
        </Tabs>
      </Box>
      ...
      <Grid item xs={12}>
          <Paper elevation={3} sx={{ p: 2, m: 2 }}>
           {/*  <Stack direction={"row"}>
            ...
            scrollbarColor: "black black", // Siyah renk için
           // WebkitScrollbarColor: "black black", // Webkit uyumluluğu için
            scrollbarWidth: "thin", // Scrollbar genişliği ayarı
            WebkitOverflowScrolling:"touch"}}>
              {castAndCrew?.cast.slice(0, 10).map((member, index) => (
                <Card
                  key={member.id}
