...
type MovieDetails = {
  ...
  export type{TabPanelProps,MovieImageList,MovieImageDetails,MovieCreditsDTO,CrewMemberDTO,CastMemberDTO,VideoResultDTO,MovieSimilarListDTO,MovieSimilarkDTO,ReviewListDTO,ReviewDTO,MovieResult,MoviePopularDTO,MovieDTO,MovieDetails}
